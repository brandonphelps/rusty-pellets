###########################################################################
## Makefile generated for Simulink model 'GunControllerMega'. 
## 
## Makefile     : GunControllerMega.mk
## Generated on : Thu Dec 22 15:37:41 2022
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/GunControllerMega.elf
...
PRODUCT_NAME              = GunControllerMega
MAKEFILE                  = GunControllerMega.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/marqu/OneDrive/Desktop/Simulink/THEPRO~1/MEGAGU~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/marqu/DOCUME~1/MATLAB/R2020a/ARDUIN~1/ARDUIN~3/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/GunControllerMega.elf
...
DEFINES_ = -D_RTT_SPI_BITORDER_=MSBFIRST -D_RTT_SPI_MODE_=SPI_MODE0 -D_RTT_SPI_SSPIN_=3 -DMODEL=GunControllerMega -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=5 -DMW_PRESCALAR=64 -DMW_TIMERCOUNT=59286 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_SPI_CLOCK_=4000000 -D_RTT_CAN_BAUD_=125 -D_RTT_CAN_OSC_=8 -D_RTT_CAN_SPI_SSPIN_=10 -D_RTT_CAN_INTERRPUT_PIN_=2 -D_RTT_CAN_ALLOW_ALL_=1 -D_RTT_CAN_BUFFER0_TYPE_=0 -D_RTT_CAN_MASK0_=0 -D_RTT_CAN_FILTER0_=0 -D_RTT_CAN_FILTER1_=0 -D_RTT_CAN_BUFFER1_TYPE_=0 -D_RTT_CAN_MASK1_=0 -D_RTT_CAN_FILTER2_=0 -D_RTT_CAN_FILTER3_=0 -D_RTT_CAN_FILTER4_=0 -D_RTT_CAN_FILTER5_=0 -DMW_NUM_CAN_RECEIVE_RAW=1 -DMW_NUM_CAN_TRANSMIT=2 -DMW_NUM_CAN_RECEIVE_CAN_MSG=0
...
DEFINES_STANDARD = -DMODEL=GunControllerMega -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_SPIwriteRead.o MW_ArduinoCAN.o GunControllerMega.o GunControllerMega_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o MW_PWMDriver.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/GunControllerMega_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/GunControllerMega_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/GunControllerMega_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
GunControllerMega.o : $(START_DIR)/GunControllerMega_ert_rtw/GunControllerMega.c
	$(CC) $(CFLAGS) -o "$@" "$<"


GunControllerMega_data.o : $(START_DIR)/GunControllerMega_ert_rtw/GunControllerMega_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/GunControllerMega_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/GunControllerMega_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/GunControllerMega_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/GunControllerMega_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
